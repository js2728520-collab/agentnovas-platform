...
export default function MarketNewsSettings(){
  ...
  return <section className="market-news-settings">
    ...
    <div className="integration-grid">
      <article className="integration-card"><span className="integration-icon">↗</span><div><b>实时行情</b><small>币种报价、涨跌幅与行情雷达</small></div><strong>Binance Spot REST</strong><code>/api/market/ticker</code><label>行情服务地址<input value="https://data-api.binance.vision" readOnly/></label><div className="integration-status"><i/>公共行情接口 · 无需 API Key</div></article>
