...
const CLIENT_ROUTES = new Set(["login", "dashboard", "legal", "account", "membership", "credits", "performance-statements", "paper", "trading-hall", "market", "assistant", "wallet", "notifications", "support"]);
