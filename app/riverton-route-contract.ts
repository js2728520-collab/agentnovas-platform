...
const CLIENT_ROUTES = new Set(["login", "dashboard", "legal", "account", "membership", "credits", "performance-statements", "paper", "trading-hall", "work-records", "market", "marketplace", "follows", "assistant", "studio", "backtests", "wallet", "notifications", "support"]);
const OPERATIONS_ROUTES = new Set(["login", "account", "accounts", "customers", "team", "data-center", "membership-orders", "performance-statements", "credits", "deposits", "ledger", "finance", "approvals", "access", "kill-switches", "follow-risk", "live-routing", "invitations"]);
