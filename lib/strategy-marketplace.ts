export function splitStrategyPerformanceFee(grossPerformanceFeeUsdt:number,collectionStatus:"confirmed"|"pending"|"failed"|"reversed"="confirmed",publicationMode:"marketplace"|"self_use"="marketplace"){
  ...
  if(publicationMode==="self_use")return{grossPerformanceFeeUsdt:gross,platformFeeUsdt:0,authorAmountUsdt:gross,eligibleRevenueUsdt:0};
