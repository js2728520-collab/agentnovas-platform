...
export const PERMISSION_DEFINITIONS: PermissionDefinition[] = [
  ...
  { key: "maint.releases.workflow.view", appId: "maintenance", label: "查看受限发布工作流" },
  { key: "maint.releases.workflow.stage", appId: "maintenance", label: "请求与复核 staging 发布", sensitive: true },
  { key: "maint.releases.workflow.production.request", appId: "maintenance", label: "请求 production 发布", sensitive: true },
  { key: "maint.releases.workflow.production.approve", appId: "maintenance", label: "审批 production 发布", sensitive: true },
  { key: "maint.releases.workflow.activation.request", appId: "maintenance", label: "请求发布 activation", sensitive: true },
  { key: "maint.releases.workflow.activation.approve", appId: "maintenance", label: "审批发布 activation", sensitive: true },
  { key: "maint.releases.workflow.production.enable", appId: "maintenance", label: "首次启用 production", sensitive: true },
  { key: "maint.releases.workflow.stop", appId: "maintenance", label: "停止受限发布工作流", sensitive: true },
  { key: "maint.releases.workflow.stop.release", appId: "maintenance", label: "批准解除发布 stop", sensitive: true },
  ...
  switch (role) {
    ...
    case "tech_staff":
      ...
      return [{ appId: "maintenance", roleCode: "maint_technical", permissions: [
        ...
        { permissionKey: "maint.releases.workflow.view", scope: "PLATFORM" },
        { permissionKey: "maint.releases.workflow.stage", scope: "PLATFORM" },
        { permissionKey: "maint.releases.workflow.production.request", scope: "PLATFORM" },
        { permissionKey: "maint.releases.workflow.activation.request", scope: "PLATFORM" },
