...
- `specs/VERSIONED_CONFIGURATION_FRAMEWORK_SPEC.md`：通用配置 draft/test/approve/schedule/activate/rollback 合同；T3.1a 内核/API 与 T3.1b-UI 工作台已实现，自动激活 Worker 和具体配置族仍为 Target。
