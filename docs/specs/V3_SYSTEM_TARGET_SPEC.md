...
当前 S0 只允许在独立 G3 证据通过后纳入 Paper/Demo 策略市场与 Paper 跟单配置；这不代表任何真实订单、真实结算或 live 资金副作用已授权。真实订单跟单须通过 G4/G4A 的独立 provider/environment/product Gate；作者/平台分账、收益分成结算和其它真实商业副作用须另行通过商业与账本 Gate。
