...
const readMigration = name => readFile(new URL(`../postgres/migrations/${name}`, import.meta.url), "utf8");
...
test("commercial migration seeds immutable v1 price snapshots and approval primitives", async () => {
  ...
  for (const fragment of [
    "membership_monthly_v1", "membership_quarterly_v1", "membership_annual_v1", "membership_lifetime_v1",
    "28", "58", "198", "588", "1000", "3000", "12000", "36000", "2000", "1600",
    "commercial_membership_orders", "commercial_payment_evidence", "membership_entitlement_events",
