...
- [-] 4.12 完成 G3 和策略市场浏览器验收。真实 Chromium 用例与质量夹具已写入：策略广场/我的跟单、四断点、键盘、axe、披露勾选、筛选/排序和零 live order/deployment 请求；本机执行被非本项目进程占用 `localhost:3002` 阻断，尚无本轮通过证据，因此 G3 不标完成。
